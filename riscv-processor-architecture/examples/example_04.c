...
void example_04(void)
{
  ...
  /* address range to protect against read/write: 0x80001000 -- 0x80003000
     region index: 0
	 address match encoding: tor encoding
  */
  ...
  *(volatile uint32_t*)0x80001000 = 0x12345678;
  ...
  region_cfg.configuration = 0x8C;  // binary : 10001100 --> set lock bit to 1 to enable the check on machine mode access based privilege
